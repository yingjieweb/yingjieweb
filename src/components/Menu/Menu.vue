<template>
  <nav class="nav">
    <PCMenu class="pc-menu" :menu="menu" :selected="selected"/>
    <MobileMenu class="mobile-menu" :menu="menu" :selected="selected"/>
  </nav>
</template>
...
<script lang="ts">
  ...
  export default class Menu extends Vue {
    menu: TMenuItem[] = [
      ...
      {route: '/wish-list', label: '人生清单', icon: 'el-icon-s-order'}
    ]
